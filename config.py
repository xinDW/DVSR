...
label =  'test_data_pipeline'
config.label = label
#config.archi = '2stage_interp_first'
config.archi = '2stage_resolve_first'

config.TRAIN.lr_img_path = "data/brain/brain20190316/crop160X160X80/lr/"
config.TRAIN.hr_img_path = "data/brain/brain20190316/crop160X160X80/hr/"
config.TRAIN.mr_img_path = "data/brain/brain20190316/crop160X160X80/hr/ds/"
